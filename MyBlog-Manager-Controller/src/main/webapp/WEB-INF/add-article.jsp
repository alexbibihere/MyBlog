...
<section class="container-fluid">
    ...
    <div class="row">
        <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                <li class="active"><a href="${pageContext.request.contextPath}/article">文章</a></li>
                ...
                <form action="${pageContext.request.contextPath}/article/add" method="post" class="add-article-form"
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="add-article-box">
                            ...
                            <div class="add-article-box-content">
                                <textarea class="form-control" name="articleDescribe" autocomplete="off"></textarea>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="add-article-box">
                            ...
                            <div class="add-article-box-content">
                                <ul class="category-list">
                                    <li>
                                        <label><input name="articleColumn" type="radio" value="前端技术"
                                                      checked>前端技术</label>
                                        <label><input name="articleColumn" type="radio" value="后端程序">后端程序</label>
                                        <label><input name="articleColumn" type="radio" value="授人以渔">授人以渔</label>
                                        <label><input name="articleColumn" type="radio" value="程序人生">程序人生</label>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="add-article-box">
                            ...
                            <div class="add-article-box-content">
                                <input type="text" class="form-control" placeholder="输入新标签" name="label"
                                       autocomplete="off">
                        ...
                        <div class="add-article-box">
                            ...
                            <div class="add-article-box-content">
                                <input type="text" class="form-control" placeholder="点击按钮选择图片" id="titleImages"
                                       name="titleImages" autocomplete="off">
                            </div>
...
<div class="modal fade user-select" id="WeChat" tabindex="-1" role="dialog" aria-labelledby="WeChatModalLabel">
    <div class="modal-dialog" role="document" style="margin-top:120px;max-width:280px;">
        <div class="modal-content">
            ...
            <div class="modal-body" style="text-align:center"><img src="${contextPath}/images/weixin.jpg" alt=""
