      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            <li><a href="${path}/">消息 <span class="badge">1</span></a></li>
            ...
            <li><a href="${path}/login" onClick="if(!confirm('是否确认退出？'))return false;">退出登录</a></li>
  ...
  <div class="row">
    <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
      ...
      <ul class="nav nav-sidebar">
        ...
        <li><a href="${path}/notice">公告</a></li>
        <li><a href="${path}/comment">评论</a></li>
        <li><a data-toggle="tooltip" data-placement="top" title="网站暂无留言功能">留言</a></li>
      </ul>
      <ul class="nav nav-sidebar">
        <li><a href="${path}/category">栏目</a></li>
...
<div class="modal fade user-select" id="WeChat" tabindex="-1" role="dialog" aria-labelledby="WeChatModalLabel">
  <div class="modal-dialog" role="document" style="margin-top:120px;max-width:280px;">
    <div class="modal-content">
      ...
      <div class="modal-body" style="text-align:center"> <img src="${path}/images/weixin.jpg" alt="" style="cursor:pointer"/> </div>
    </div>
  </div>
</div>
<!--提示模态框-->
...
<script type="application/javascript">
    ...
    function toPage(pn) {
        $.ajax({
            type: "GET",
            url: "${pageContext.request.contextPath}/log/getLog",
            data: "pn=" + pn,
    ...
    function build_user_table(result) {
        ...
        var log = result.map.pageInfo.list;
	...
	$("#main table tbody tr td a").click(function(){
		...
		if (event.srcElement.outerText === "删除") 
		{
			if(window.confirm("此操作不可逆，是否确认？"))
			{
				$.ajax({
					type: "POST",
					url: "${path}/Loginlog/delete/action/one",
					data: "id=" + id,
					cache: false, //不缓存此页面   
