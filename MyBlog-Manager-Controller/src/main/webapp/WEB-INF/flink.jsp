      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            <li><a href="${contextPath}/">消息 <span class="badge">1</span></a></li>
  ...
  <div class="row">
      ...
      <ul class="nav nav-sidebar">
        ...
        <li><a class="dropdown-toggle" id="settingMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">设置</a>
          <ul class="dropdown-menu" aria-labelledby="settingMenu">
            ...
            <li role="separator" class="divider"></li>
            <li><a href="${contextPath}/#">安全配置</a></li>
            <li role="separator" class="divider"></li>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <form action="" method="post" >
        ...
        <ol class="breadcrumb">
          <li><a href="${contextPath}/add-flink" class="btn btn-primary">增加友情链接</a></li>
        </ol>
          ...
          <table class="table table-striped table-hover" id="linkList">
            ...
            <tbody>
             <%-- <tr>
                ...
                <td><a href="${contextPath}/update-flink.html">修改</a> <a rel="6">删除</a></td>
              </tr>--%>
            </tbody>
          </table>
        </div>
...
<script type="application/javascript">
    ...
    function toPage(pn) {
        $.ajax({
            type: "GET",
            url: "${pageContext.request.contextPath}/link/getAllLink",
            data: "pn=" + pn,
    ...
    function build_user_table(result) {
        $("#linkList tbody").empty();

        var link = result.map.pageInfo.list;
        $.each(link, function (index, item) {
           ...
           */
            ...
            var operate = $("<td></td>").append(" ")
                .append(delbtn);
            $("<tr></tr>").append(userIdTd).append(titleTd)
                .append(urlTd)
               .append(operate).appendTo($("#linkList tbody"));
        });
    }
