...
<section class="container-fluid">
  ...
  <div class="row">
    <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
      ...
      <ul class="nav nav-sidebar">
        <li class="active"><a href="${path}/article">文章</a></li>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <form action="" method="post" >
        ...
        <ol class="breadcrumb">
          <li><a href="${path}/add-article" class="btn btn-primary">增加文章</a></li>
        </ol>
...
//            //var checkBoxTd = $("<td></td>").append($("<input></input>").attr("type","checkbox"));
           var userIdTd = $("<td></td>").append(item.id);
            ...
            var columnTd = $("<td></td>").append(item.articleColumn);
            var labelTd = $("<td></td>").append(item.label);
            var commentTd = $("<td></td>").append(getComment(item.id)==null ?"0":"getComment(item.id)");
            ...
            var operate = $("<td></td>").append(editbtn)
                .append(" ")
                .append(delbtn);
            $("<tr></tr>").append(titleTd).append(columnTd).append(labelTd).append(commentTd).append(createTimeTd).append(operate).appendTo($("#articleList tbody"));
        });
    }
