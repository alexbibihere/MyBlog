...
public class MvcTest {
    ...
    public void page() throws Exception{
        //服务器端根据浏览器的数据产生的结果
        MvcResult result=mvc.perform(MockMvcRequestBuilders.get("/user/getAllUser").param("pn", "1")).andReturn();

        //服务器端返回给浏览器的数据
        MockHttpServletRequest request=result.getRequest();
        PageInfo<User> info=(PageInfo<User>) request.getAttribute("pageInfo");
        //当前页码
